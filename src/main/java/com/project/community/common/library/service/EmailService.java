...
public class EmailService {
     ...
     * Send OTP email
     */
    public void sendInviteEmail(String toEmail, String url) {
        try {
            SimpleMailMessage message = new SimpleMailMessage();
            message.setFrom(fromEmail);
            message.setTo(toEmail);
            message.setSubject("Your Community Library registration link");
            message.setText(buildInviteEmailContent(url));
    ...
    private String buildInviteEmailContent(String url) {
        return String.format(
                "Your Your Community Library registration link is: %s\n\n" +
    ...
    private String buildHtmlLinkEmailContent(String url) {
        return String.format(
                "<html>" +
                        "<body style='font-family: Arial, sans-serif;'>" +
                        "<div style='max-width: 600px; margin: 0 auto; padding: 20px;'>" +
